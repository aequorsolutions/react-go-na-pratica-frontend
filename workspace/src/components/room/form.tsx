...
export function FormSendMessage() {
    ...
    return (
        <form action={handleSubmit} className="flex flex-col md:flex-row bg-zinc-900 border border-zinc-800 rounded-xl w-full p-2 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-1">
            <input 
                    type="text"
                    name= "message"
